...
# Target: Raspberry Pi or Codex server running Lucidus instance

API_ROOT="http://localhost/wp-json/lucidus/v1"
USER_ID=1234  # Replace with actual test user ID

LOG_FILE="chat_api_test_results.log"
echo "🧪 Starting Lucidus Chat API tests..." > $LOG_FILE

# Test 1: Send a chat message (simulate user input)
